...
def registro_insertar(func):
    """
    Decorador: Informa de un nuevo registro en la consola.
    """
...
def registro_modificacion(func):
    """
    Decorador: Informa de una modificacion de un registro en la consola.
    """
...
def registro_eliminacion(func):
    """
    Decorador: Informa de la eliminacion de un registro en la consola.
    """
