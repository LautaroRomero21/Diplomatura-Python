...
class Ventana:
    ...
    def __init__(self, app, base_conectada, servidor) -> None:
        self.ventana = app
        ...
        self.boton_prender = Boton(
            self.ventana,
            texto="Prender Serv",
            color_fondo="#39FF33",
            fuente="Helvetica 8 bold",
            funcion_info=self.servidor.iniciar_servidor,
            place_info={"x": 100, "y": 293, "relwidth": 0.1, "relheight": 0.07},
        )
        self.boton_apagar = Boton(
            self.ventana,
            texto="Apagar Serv",
            color_fondo="#f00",
            fuente="Helvetica 8 bold",
            funcion_info=self.servidor.apagar_servidor,
            place_info={"x": 180, "y": 293, "relwidth": 0.1, "relheight": 0.07},
        )
